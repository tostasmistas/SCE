...
int main(){
	...
	printf("Floting point threads (0 and 1) sharing the same Core (but in differenet hiperthreads) \n");
	printf("Integer       threads (2 and 3) sharing the same Core (but in differenet hiperthreads) \n");
