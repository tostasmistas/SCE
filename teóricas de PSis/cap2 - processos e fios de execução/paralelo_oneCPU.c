...
/* ja consegue intercalar instruções int com float */
...
int main(){
	...
	printf("All thread (Floting point & integer) (0, 1, 2 and 3) sharing the same Core  \n");

	
	pthread_create(&t1[0], NULL, func_1, (void*) 0);
	pthread_create(&t1[1], NULL, func_1, (void*) 1);
	pthread_create(&t1[2], NULL, func_2, (void*) 0);
	pthread_create(&t1[3], NULL, func_2, (void*) 1);
